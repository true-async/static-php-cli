...
class SourcePatcher
{
    ...
    public static function patchPhpSrc(?array $items = null): bool
    {
        ...
        foreach ($patch_list as $patchName) {
            ...
            // For a version newer than the newest known one, fall back from the
            // newest entry instead of array_search() returning false (which would
            // index $serial[0] and wrongly pick the oldest patch).
